...
ax1=plt.axes([0.15,0.15,0.67,0.75])
    
ax1.set_title(sys.argv[2], fontsize=14)
ax1.set_xlabel('GC Content', fontsize=14) # fontweight='semibold', fontsize=16, family='Arial', labelpad=15)
new_y = np.ma.masked_where(normCov_gc==0, normCov_gc)
ax1.scatter(bins[1:], new_y, s=3, color='black')
ax1.set_ylabel('Normalized Coverage', fontsize=14) # fontweight='semibold', fontsize=16, family='Arial', labelpad=15)
...
ax2.set_ylabel('Target GC Histogram', fontsize=14) #fontweight='bold', fontsize=16, family='Sans', labelpad=10)
ax2.tick_params(axis='both', which='major', labelsize=12, length=6, width=1)
